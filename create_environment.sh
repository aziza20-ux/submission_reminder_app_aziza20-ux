...
kaliza, Shell Navigation, not submitted
bobo, Shell Navigation, submitted
Neza, Shell Navigation, not submitted
asa, Shell Navigation, not submitted
EOF
...
echo "WOW YOU CAN NOW RUN YOUR REMINDER APP JUST TYPE ./startup.sh AND SEE THE MAGIC"
